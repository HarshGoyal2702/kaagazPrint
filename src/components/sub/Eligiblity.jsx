    ...
    <div className="min-h-[50vh] bg-white shadow-md">
     ...
     <div className="collapse collapse-arrow bg-base-200 shadow-md text-black">
        ...
        <div className="collapse-content">
          <p>If you are a minor, i.e., under the age of 18 years, you may use/access the Marketplace under the supervision of an adult parent or legal guardian who agrees to be bound by these Terms of Use. You are however prohibited (even under supervision) from purchasing any product(s) which is for adult consumption, the sale of which to minors is prohibited.
          </p>
        </div>
      </div>
