...
const Process = () => {
    ...
    return (
        ...
        <div className='w-full min-h-screen pl-14 pr-14 overflow-hidden' >
            <hr className='' />
            <div className='flex items-center justify-center mt-4'> <ul className="steps steps-vertical lg:steps-horizontal">
            ...
            <ul className="timeline timeline-snap-icon mt-4 max-md:timeline-compact timeline-vertical">
                <li>
                    <div className="timeline-middle">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="purple" className="h-5 w-5"><path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.857-9.809a.75.75 0 00-1.214-.882l-3.483 4.79-1.88-1.88a.75.75 0 10-1.06 1.061l2.5 2.5a.75.75 0 001.137-.089l4-5.5z" clipRule="evenodd" /></svg>
                    </div>
                    <div className="timeline-start md:text-end mb-10 p-5">
                        ...
                        <p className='ml-14'>you can simply login/register youself to our website with fully functional email and password authentication. and gmail validation</p>
                    </div>
                    <hr />
                </li>
                <li>
